...
pycbc_make_bank_verifier_workflow --config-files global_setup.ini --workflow-name bank_verificator --output-dir /home/marion.pillas/projects/template_bank/O3PSD/output_heavy_BBH_fstart5/ --submit-now
